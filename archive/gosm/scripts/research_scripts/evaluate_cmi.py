...
def count(number, daylist_in, series, num_processes = 30):
    """
    ...
    with mp.Pool(num_processes) as pool:
        ...
        dayruns = [pool.apply_async(compute_multi_interval.main, (future_time,))
