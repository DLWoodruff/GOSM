...
export PRESCIENT_PATH=$PRESCIENT_PATH/release/Prescient_${PRESCIENT_VERSION}
...
python $PRESCIENT_PATH/exec/prescient.py \
       ...
       --output-directory=caiso_simple_loadonly_march_2015 \
       --ruc-horizon=48 \
       --scenarios-populate-datesfile=$PRESCIENT_PATH/data/CAISO/caiso_dates_march_2015.dat \
