...
def set_list(file, future_time, hour_range_size, threshold, separation):
    ...
    """
    data = percentage.read_data(file, future_time, hour_range_size)
...
def count(number, daylist_in, series, ws, num_processes = 30):
    ...
    with mp.Pool(num_processes) as pool:
        ...
        dayruns = [pool.apply_async(percentage.main, (future_time, ws,))
...
def main(ws):
    ...
    with open('../research_results/evaluation_percentage_' + date
