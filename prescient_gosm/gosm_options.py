...
def set_globals(options_file=None, args=None):
    ...
    parser.add_argument('--planning-period-length',
                        help='The time period you want the scenarios for.'
                             ' Must be an integer directly follwed by a string'
                             ' which refers to the frequency. (e.g. a lead '
                             'of 4 hours is represented by "4H")',
                        action='store',
                        dest='planning_period_length')
    ...
    parser.add_argument('--error_tolerance',
                        help='The amount to increase the error tolerance'
                             'for the integration process. This is in terms of '
                             'powers of 10. Example: 3 will give an error tolerance'
                             '10^3 greater than the default.',
                        type=int,
    ...
    parser.add_argument("--use-markov-chains",
                        help="Set this option if you wish to use Markov Chains"
                             " to construct scenarios.",
                        action="store_true",
                        dest="use_markov_chains")
    ...
    parser.add_argument('--copula-random-walk',
                        help='Set this option, if you want to use copulas '
                             'for computing the transition probabilities '
                             'for the Markov Chain random walk.',
                        action='store_true',
                        dest='copula_random_walk')
