...
import prescient_gosm.scenario_creator as scenario_creator
import prescient_gosm.populator_options as populator_options
...
def cluster_sources(data_sources):
    ...
    for source in data_sources:
        ...
        end_date = gosm_options.scenario_day-pd.Timedelta(source.time_step)
...
def create_scenarios(date, data_sources):
   ...
   #     historic_end = None
    ...
    if populator_options.interpolate_data:
        interpolate_sources(data_sources)
