...
python $PRESCIENT_PATH/exec/prescient.py \
       --run-simulator \
       --data-directory=caiso_simple_loadonly_september_2014 \
       --model-directory=$PRESCIENT_PATH/models/latorre \
       --output-directory=caiso_simple_loadonly_deterministic_september_2014 \
       ...
       --reserve-factor=0.05 \
       --solver=gurobi \
       --deterministic-ruc-solver-options="RINS=100 Heuristics=0.30 Threads=4 TimeLimit=1800" \
       --output-solver-logs \
